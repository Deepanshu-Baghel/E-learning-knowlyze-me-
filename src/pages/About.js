...
<div className="card-client">
  <div className="user-picture">
    ...
    <img className='pick' src="https://i.ibb.co/CBZxSRJ/profile-pic.jpg" alt="User Picture" />
  </div>
...
<div className="card-client">
  <div className="user-picture">
    ...
    <img className='picn' src="https://i.ibb.co/2WRkQJ6/nandu-pp.png" alt="User Picture" />
...
<div className="card-client">
  <div className="user-picture">
    ...
    <img className='pic' src="https://i.ibb.co/3z1FWxm/ishan-and-subhod.png" alt="User Picture" />
...
<div className="card-client">
  <div className="user-picture">
    ...
    <img className='picu' src="https://i.ibb.co/x6nLBWZ/anshika-pp.png" alt="User Picture" />
  </div>
...
<div className="card-client">
  <div className="user-picture">
    ...
    <img className='picq' src="https://i.ibb.co/3z1FWxm/ishan-and-subhod.png" alt="User Picture" />
  </div>
  <p className="name-client"> Ishan Gagan
    <span>creative Support
    </span>
  </p>
  <div className="social-media">
    <a href="#">
...
<div className="card-client">
  <div className="user-picture">
    ...
    <img className='picu' src="https://i.ibb.co/Y88dJd1/manchit.png" alt="User Picture" />
  </div>
  <p className="name-client"> Manchit 
    <span> Word Document support
    </span>
  </p>
  <div className="social-media">
    <a href="#">
